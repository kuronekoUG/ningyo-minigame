...
assert.ok(getScrollSpeed(90) > getScrollSpeed(80));
assert.equal(getScrollSpeed(160), getScrollSpeed(120));
assert.ok(getSpawnInterval(60) < getSpawnInterval(45));
assert.ok(getSpawnInterval(80) < getSpawnInterval(60));
assert.ok(getSpawnInterval(90) < getSpawnInterval(80));
assert.equal(getSpawnInterval(160), getSpawnInterval(120));
assert.equal(getRockCount(0), 1);
assert.equal(getRockCount(32), 2);
assert.equal(getRockCount(60), 3);
assert.equal(getRockCount(90), 4);
